...
this["templates"]["canvas"] = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers; data = data || {};
  


  return "<canvas height=\"600\" width=\"800\" id=\"canvas\"></canvas>";});
(function(){
...
require.define("/client/Application.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var Application, MainView, Router, TileCollection;
...
require.define("/client/Router.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var Calamity, Router,
  ...
  module.exports = Router = (function(_super) {
    ...
    Calamity.proxy(Router.prototype);
...
require.define("/node_modules/calamity/package.json",function(require,module,exports,__dirname,__filename,process){module.exports = {"main":"calamity.js"}});

require.define("/node_modules/calamity/calamity.js",function(require,module,exports,__dirname,__filename,process){/*! CalamityJS 0.2.0 - MIT license */
...
EmitterMixin = C.EmitterMixin = (function() {
  ...
  EmitterMixin.prototype._trigger = function(address, data, reply) {
    if (!hasEmitterBus(this)) {
      return;
    }
...
EventBridge = C.EventBridge = (function() {
  ...
  EventBridge.prototype.connect = function(bus) {
    this._busses.push(bus);
    bus.subscribe("*", _.bind(this.handler, this));
    return this;
  };

  EventBridge.prototype.handler = function(msg) {};
...
EventMessage = C.EventMessage = (function() {
  ...
  function EventMessage(address, data, _replyHandler) {
    this.address = address;
    this.data = data;
    this._replyHandler = _replyHandler;
    this.id = util.genId();
    this._busses = [];
    if (!(_.isUndefined(this._replyHandler) || _.isFunction(this._replyHandler))) {
      throw new Error("Reply must be a function");
    }
  }

  EventMessage.prototype.reply = function(data) {
    var replyHandler;
  ...
  EventMessage.prototype.serialize = function() {
...
EventMessage.deserialize = function(json) {
  return void 0;
};
...
ProxyMixin = C.ProxyMixin = (function() {
  ...
  ProxyMixin.prototype._subscribe = function(address, handler) {
    return this._calamity.proxy.bus.subscribe(address, handler, this);
  };

  ProxyMixin.prototype._publish = function(address, data, reply) {
...
require.define("/node_modules/calamity/node_modules/underscore/package.json",function(require,module,exports,__dirname,__filename,process){module.exports = {"main":"underscore.js"}});

require.define("/node_modules/calamity/node_modules/underscore/underscore.js",function(require,module,exports,__dirname,__filename,process){//     Underscore.js 1.4.3
...
require.define("/client/views/MainView.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var CanvasView, MainView, View,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
require.define("/client/views/View.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var Calamity, View,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
require.define("/client/views/CanvasView.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var CanvasView, View,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  module.exports = CanvasView = (function(_super) {
    ...
    CanvasView.prototype.el = '#canvasContainer';
...
require.define("/client/collections/TileCollection.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var Collection, Tile, TileCollection,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  module.exports = TileCollection = (function(_super) {

    __extends(TileCollection, _super);

    function TileCollection() {
      return TileCollection.__super__.constructor.apply(this, arguments);
    }

    TileCollection.prototype.model = Tile;

    TileCollection.prototype.initialize = function() {
      return this.buildGrid();
    };

    TileCollection.prototype.buildGrid = function() {
      var col, cols, row, rows, tileSize, x, y;
      rows = 15;
      cols = 20;
      tileSize = 32;
      col = 0;
...
require.define("/client/collections/Collection.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var Collection,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
require.define("/client/models/TileModel.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var Model, Tile,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
require.define("/client/models/Model.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var Calamity, Model,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  module.exports = Model = (function(_super) {
    ...
    Calamity.proxy(Model.prototype);
...
require.define("/client/init.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  var Application;
  ...
  $(function() {
    var ct;
    ct = new Application();
    return ct.initialize();
  });

}).call(this);
});
require("/client/init.coffee");
